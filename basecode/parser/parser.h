...
namespace basecode::syntax {
    ...
    class yield_prefix_parser : public prefix_parser {
    public:
        yield_prefix_parser() = default;
    ...
    private:
        ...
        infix_parser* infix_parser_for(token_type_t type);

        prefix_parser* prefix_parser_for(token_type_t type);
    ...
    private:
        ...
        static inline yield_prefix_parser s_yield_prefix_parser {};
        ...
        static inline std::unordered_map<token_type_t, prefix_parser*> s_prefix_parsers = {
            {token_type_t::if_literal,             &s_if_prefix_parser},
            {token_type_t::bang,                   &s_not_prefix_parser},
            {token_type_t::enum_literal,           &s_enum_prefix_parser},
            {token_type_t::with_literal,           &s_with_prefix_parser},
            {token_type_t::from_literal,           &s_from_prefix_parser},
            {token_type_t::label,                  &s_label_prefix_parser},
            {token_type_t::left_paren,             &s_group_prefix_parser},
            {token_type_t::union_literal,          &s_union_prefix_parser},
            {token_type_t::defer_literal,          &s_defer_prefix_parser},
            {token_type_t::yield_literal,          &s_yield_prefix_parser},
            {token_type_t::struct_literal,         &s_struct_prefix_parser},
            {token_type_t::for_literal,            &s_for_in_prefix_parser},
            {token_type_t::minus,                  &s_negate_prefix_parser},
            {token_type_t::return_literal,         &s_return_prefix_parser},
            {token_type_t::identifier,             &s_symbol_prefix_parser},
            {token_type_t::module_literal,         &s_module_prefix_parser},
            {token_type_t::spread_operator,        &s_spread_prefix_parser},
            {token_type_t::raw_block,              &s_raw_block_prefix_parser},
            {token_type_t::namespace_literal,      &s_namespace_prefix_parser},
            ...
            {token_type_t::block_comment,          &s_block_comment_prefix_parser},
            {token_type_t::string_literal,         &s_string_literal_prefix_parser},
            {token_type_t::number_literal,         &s_number_literal_prefix_parser},
            {token_type_t::while_literal,          &s_while_statement_prefix_parser},
            {token_type_t::proc_literal,           &s_proc_expression_prefix_parser},
            {token_type_t::true_literal,           &s_keyword_literal_prefix_parser},
            {token_type_t::nil_literal,            &s_keyword_literal_prefix_parser},
            {token_type_t::false_literal,          &s_keyword_literal_prefix_parser},
            {token_type_t::break_literal,          &s_keyword_literal_prefix_parser},
            {token_type_t::import_literal,         &s_keyword_literal_prefix_parser},
            {token_type_t::continue_literal,       &s_keyword_literal_prefix_parser},
            {token_type_t::switch_literal,         &s_keyword_literal_prefix_parser},
            {token_type_t::case_literal,           &s_keyword_literal_prefix_parser},
            {token_type_t::fallthrough_literal,    &s_keyword_literal_prefix_parser},
            {token_type_t::question,               &s_keyword_literal_prefix_parser},
        ...
        static inline std::unordered_map<token_type_t, infix_parser*> s_infix_parsers = {
            {token_type_t::plus,                       &s_sum_bin_op_parser},
            {token_type_t::minus,                      &s_sum_bin_op_parser},
            {token_type_t::comma,                      &s_comma_infix_parser},
            {token_type_t::slash,                      &s_product_bin_op_parser},
            {token_type_t::percent,                    &s_product_bin_op_parser},
            {token_type_t::asterisk,                   &s_product_bin_op_parser},
            {token_type_t::key_value_operator,         &s_key_value_infix_parser},
            {token_type_t::exponent,                   &s_exponent_bin_op_parser},
            {token_type_t::left_paren,                 &s_proc_call_infix_parser},
            {token_type_t::equals,                     &s_equality_bin_op_parser},
            {token_type_t::not_equals,                 &s_equality_bin_op_parser},
            {token_type_t::assignment,                 &s_assignment_infix_parser},
            {token_type_t::less_than,                  &s_relational_bin_op_parser},
            {token_type_t::greater_than,               &s_relational_bin_op_parser},
            {token_type_t::less_than_equal,            &s_relational_bin_op_parser},
            {token_type_t::greater_than_equal,         &s_relational_bin_op_parser},
            {token_type_t::logical_or,                 &s_logical_or_bin_op_parser},
            {token_type_t::pipe,                       &s_bitwise_or_bin_op_parser},
            {token_type_t::ampersand,                  &s_bitwise_and_bin_op_parser},
            {token_type_t::xor_literal,                &s_bitwise_xor_bin_op_parser},
            {token_type_t::logical_and,                &s_logical_and_bin_op_parser},
            {token_type_t::period,                     &s_member_access_bin_op_parser},
            {token_type_t::left_square_bracket,        &s_array_subscript_infix_parser},
            {token_type_t::colon,                      &s_type_declaration_infix_parser},
            {token_type_t::plus_equal_literal,         &s_sum_with_assign_bin_op_parser},
            {token_type_t::minus_equal_literal,        &s_sum_with_assign_bin_op_parser},
            {token_type_t::caret,                      &s_pointer_dereference_infix_parser},
            {token_type_t::constant_assignment,        &s_constant_assignment_infix_parser},
            {token_type_t::divide_equal_literal,       &s_product_with_assign_bin_op_parser},
            {token_type_t::modulus_equal_literal,      &s_product_with_assign_bin_op_parser},
            {token_type_t::multiply_equal_literal,     &s_product_with_assign_bin_op_parser},
            {token_type_t::shl_literal,                &s_bitwise_shift_or_roll_bin_op_parser},
            {token_type_t::shr_literal,                &s_bitwise_shift_or_roll_bin_op_parser},
            {token_type_t::rol_literal,                &s_bitwise_shift_or_roll_bin_op_parser},
            {token_type_t::ror_literal,                &s_bitwise_shift_or_roll_bin_op_parser},
            {token_type_t::binary_or_equal_literal,    &s_bitwise_or_with_assign_bin_op_parser},
            {token_type_t::binary_and_equal_literal,   &s_bitwise_and_with_assign_bin_op_parser},
        };
